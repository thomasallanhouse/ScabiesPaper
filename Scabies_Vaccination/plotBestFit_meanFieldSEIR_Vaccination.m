...
% on 8th May 2017
% Modified to include vaccination/treatment on 14 Nov 2017
...
vFlag = 3; % Treat E and I
q = 0; % Efficacy of treatment Ivermectin = 62.4% and Permethrin = 96.9%
...
for j = 1:length(N)
    ...
    tVacc = T(j);
    [Y(:,j), fullSet(:,j)] = SEIR_Gillespie_multiple_Vaccination(370,[N(j)-1, 0, 1, 0],beta,alpha,gamma,tVacc,q,vFlag);
